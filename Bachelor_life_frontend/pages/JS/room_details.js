...
function renderRoomDetails(room) {
  ...
  if (displayType === "1bhk") displayType = "1 BHK";
  else if (displayType === "studio") displayType = "2 BHK";
  else if (displayType === "single") displayType = "Single Room";
  else if (displayType === "shared") displayType = "Shared Room";
  else if (displayType === "3bhk") displayType = "3 BHK";
  else if (displayType === "pg") displayType = "PG / Hostel";

  setSafeText("room-type", displayType);
  ...
  if (gallery) {
    ...
    mainImg.src = images.length > 0 ? getCleanPath(images[0]) : "https://placehold.co/600x400?text=No+Image";
    mainImg.className = "main-image";
    mainImg.id = "main-display-image";
    mainImg.onerror = () => (mainImg.src = "https://placehold.co/600x400?text=Image+Not+Found");
